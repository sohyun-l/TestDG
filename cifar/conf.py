...
# AMPLIFIER
_C.TEST.amplifier_rank1 = 1
_C.TEST.amplifier_rank2 = 128
_C.OPTIM.MT_AMPLIFIER = 0.999
_C.OPTIM.AMPLIFIERLR=1e-4
...
def load_cfg_fom_args(description="Config options."):
    ...
    parser.add_argument("--mse_weight", required=True, type=float)
    parser.add_argument("--proj_lr", required=True, type=float)
    parser.add_argument("--cls_weight", required=True, type=float)
    parser.add_argument("--cls_lr", required=True, type=float)
    parser.add_argument("--ms-layer", nargs='+', type=int, default=[])
    parser.add_argument("--temperature", default=0.7, type=float)
    parser.add_argument("--triplet", required=True, type=bool)
    parser.add_argument("--lr", default=3e-4, type=float)
    parser.add_argument("--amplifier_lr", default=4e-6, type=float)
    parser.add_argument("--conf_thres", default=0.16, type=float)
    ...
    cfg.OPTIM.MSE_WEIGHT = args.mse_weight
    cfg.OPTIM.PROJ_LR = args.proj_lr
    cfg.OPTIM.CLS_WEIGHT = args.cls_weight
    cfg.OPTIM.CLS_LR = args.cls_lr
    cfg.OPTIM.TEMPERATURE = args.temperature
    cfg.OPTIM.TRIPLET = args.triplet
    cfg.OPTIM.LR = args.lr
    cfg.OPTIM.AMPLIFIERLR = args.amplifier_lr
    cfg.OPTIM.CONF_THRES = args.conf_thres
